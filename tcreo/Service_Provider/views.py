...
def View_Twitter_Credibility_Type_Ratio(request):
    detection_ratio.objects.all().delete()
    rratio = ""
    kword = 'Fake'
    print(kword)
    obj = Credibility_Prediction.objects.all().filter(Q(Prediction=kword))
    obj1 = Credibility_Prediction.objects.all()
    count = obj.count();
    count1 = obj1.count();
    ...
    kword1 = 'Real'
    print(kword1)
    obj1 = Credibility_Prediction.objects.all().filter(Q(Prediction=kword1))
    obj11 = Credibility_Prediction.objects.all()
    count1 = obj1.count();
    count11 = obj11.count();
    ...
    return render(request, 'SProvider/View_Twitter_Credibility_Type_Ratio.html', {'objs': obj})
...
def ViewTrendings(request):
    topic = Credibility_Prediction.objects.values('topics').annotate(dcount=Count('topics')).order_by('-dcount')
...
def View_Prediction_Of_Twitter_Credibility_Type(request):
    obj =Credibility_Prediction.objects.all()
    return render(request, 'SProvider/View_Prediction_Of_Twitter_Credibility_Type.html', {'list_objects': obj})
