...
urlpatterns = [
    ...
    url(r'^Predict_Twitter_Credibility_Type/$', remoteuser.Predict_Twitter_Credibility_Type, name="Predict_Twitter_Credibility_Type"),
    ...
    url(r'^View_Twitter_Credibility_Type_Ratio/$', serviceprovider.View_Twitter_Credibility_Type_Ratio, name="View_Twitter_Credibility_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Twitter_Credibility_Type/$', serviceprovider.View_Prediction_Of_Twitter_Credibility_Type, name="View_Prediction_Of_Twitter_Credibility_Type"),
